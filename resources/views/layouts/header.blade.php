        ...
        <div class="container-fluid header-container-p">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6">
                    <div class="logo">
                        <a href="index.html"><img src="{{ asset('assets/img/logo/s_logo.png')}}" class="mobile-logo logo-sticky-none" alt="Logo"></a>
                        <a href="index.html"><img src="{{ asset('assets/img/logo/logo.png')}}" class="mobile-logo s-logo-none" alt="Logo"></a>
                    </div>
                </div>
                <div class="col-lg-9 col-md-6 d-none d-md-block">
                    <div class="menu-area">
                        ...
                        <div class="header-btn">
                            <a href="#" class="btn" data-toggle="modal" data-target="#exampleModalLong"><img src="{{ asset('assets/img/icon/calculator-symbols.png')}}" alt="icon">Get Fare Rate</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
